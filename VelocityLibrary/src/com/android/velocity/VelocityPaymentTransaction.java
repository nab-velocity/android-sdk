 ...
 * 
 * @author ranjitk
 * @desc VelocityPaymentTransaction will be used for set the value and get the
 *       value.
 */
public class VelocityPaymentTransaction {
	...
	public String getAmountfordjust() {
		return amountfordjust;
	}

	public void setAmountfordjust(String amountfordjust) {
		this.amountfordjust = amountfordjust;
	}
	...
	public String getBusinnessName() {
		return businnessName;
	}

	public void setBusinnessName(String businnessName) {
		this.businnessName = businnessName;
	}
	...
	public String getReportingDataReference() {
		return reportingDataReference;
	}

	public void setReportingDataReference(String reportingDataReference) {
		this.reportingDataReference = reportingDataReference;
	}

	public String getTransactionDataReference() {
		return transactionDataReference;
	}

	public void setTransactionDataReference(String transactionDataReference) {
		this.transactionDataReference = transactionDataReference;
	}
